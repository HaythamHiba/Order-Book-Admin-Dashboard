...
import { useAuctionStatusOptions } from 'utility/selectionOptions/useAuctionStatusOptions';
import {history} from '../../../../history';
import { useGetAuctionOrders } from 'api/auction_orders';

export default function AuctionOrders(props) {
  ...
  const statusOptions = useAuctionStatusOptions();
  ...
  //data
  const { data, isLoading } = useGetAuctionOrders({
    page: filterIsApplied ? filterPagination.page : page,
    per_page,
    search,
    order_by,
    order_type,
    auction_order_status: selectedStatus
  });
